...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/rpc.CreateInvoiceRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/rpc.CreateInvoiceResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "rpc.CreateInvoiceRequest": {
            "type": "object",
            "properties": {
                "payload": {
                    "$ref": "#/definitions/rpc.CreateInvoiceRequestPayload"
                },
                "public_key": {
                    "type": "string"
                },
        ...
        "rpc.CreateInvoiceRequestPayload": {
            "type": "object",
            "properties": {
                "buyer_address": {
                    "type": "string"
