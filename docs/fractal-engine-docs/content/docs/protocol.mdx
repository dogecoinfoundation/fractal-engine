...
description: On-chain protocol specification for embedding fractal-related operations into Dogecoin blockchain transactions
---

# Fractal Engine On-Chain Protocol Specification
